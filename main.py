...
def main() -> None:
  ...
  with mp_hands.Hands(
    ...
    while cap.isOpened():
      ...
      img = detector.findHands(image,False)
      lmList, _ = detector.findPosition(img, draw=False)
      if lmList:
          myHandType = detector.handType()
          cv2.putText(img,str(myHandType),(50,50),cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 3)
      ...
      cv2.putText(image, str(fingerCount), (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 0, 0), 10)
